class MorseTranslator {
  ...
  translateTo(text) {
    ...
    const translatedCharacters = characters.map((char) => this.#translateCharacterTo(char));
  ...
  #translateWordFrom(word) {
    ...
    const translated = characters.map((character) => this.#dictionaryFrom[character] ?? character);
